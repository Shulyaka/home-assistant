...
class CoreState(enum.Enum):
    ...
    running = "RUNNING"
    stopping = "STOPPING"
    stopping_integrations = "STOPPING_INTEGRATIONS"
...
class HomeAssistant:
    ...
    def is_stopping(self) -> bool:
        ...
        return self.state in (CoreState.stopping, CoreState.stopping_integrations, CoreState.final_write)
    ...
    async def async_stop(self, exit_code: int = 0, *, force: bool = False) -> None:
        ...
        if not force:
            ...
            if self.state == CoreState.not_running:  # just ignore
                return
            if self.state in [CoreState.stopping, CoreState.stopping_integrations, CoreState.final_write]:
        ...
        # stage 2
        self.state = CoreState.stopping_integrations
        self.async_track_tasks()
        self.bus.async_fire(EVENT_HOMEASSISTANT_STOP_INTEGRATIONS)
        try:
