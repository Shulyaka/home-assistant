...
from homeassistant.const import CONF_EVENT, CONF_PLATFORM, EVENT_HOMEASSISTANT_STOP_INTEGRATIONS
...
async def async_attach_trigger(
    ...
    if event == EVENT_SHUTDOWN:
        ...
        return hass.bus.async_listen_once(EVENT_HOMEASSISTANT_STOP_INTEGRATIONS, hass_shutdown)
