...
def custom_serializer(schema: Any) -> Any:
    ...
    from homeassistant.util.color import color_name_to_rgb  # pylint: disable=import-outside-toplevel
...
class IntentTool(Tool):
    ...
    def __init__(self, intent_type: str, slot_schema: vol.Schema | None = None):
        """Init the class."""
